package com.cretin.studyhelper.base;
...
import com.cretin.studyhelper.utils.ViewUtils;
...
public abstract class BaseActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(com.cetin.studyhelper.R.layout.layout_base_activity, null);
        setContentView(view);
        initHeadView(view);
